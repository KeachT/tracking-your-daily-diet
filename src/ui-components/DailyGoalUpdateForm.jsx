...
export default function DailyGoalUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = dailyGoalRecord
      ? { ...initialValues, ...dailyGoalRecord }
      : initialValues;
  ...
  const [dailyGoalRecord, setDailyGoalRecord] =
    React.useState(dailyGoalModelProp);
  React.useEffect(() => {
    ...
    queryData();
  }, [idProp, dailyGoalModelProp]);
  React.useEffect(resetStateValues, [dailyGoalRecord]);
  const validations = {
    calories: [],
    protein: [],
    carbohydrates: [],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "DailyGoalUpdateForm")}
      {...rest}
    >
      <TextField
        label="Calories"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || dailyGoalModelProp)}
