...
export default function MealCategoryCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new MealCategory(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "MealCategoryCreateForm")}
      {...rest}
    >
      <SelectField
        label="Name"
